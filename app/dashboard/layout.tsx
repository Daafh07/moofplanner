...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-screen flex-col bg-gradient-to-br from-[#0d1a10] via-[#0b1c13] to-[#060c07] text-white md:flex-row">
      <CursorController />
      <div className="group/nav w-full flex-none border-b border-white/10 bg-gradient-to-b from-[#141f0d] to-[#080f08] md:sticky md:top-0 md:h-screen md:w-20 md:overflow-y-auto md:border-b-0 md:border-r md:border-white/10 md:transition-[width] md:duration-300 md:hover:w-72">
        <SideNav />
      </div>
